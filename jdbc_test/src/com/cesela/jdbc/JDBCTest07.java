 ...
 *      PreparedStatement是属于编译的数据库的操作对象。
 *      PreparedStatement的原理是：预先对SQL语句的框架进行编译，让后再给SQL语句传“值”。
 *  2、测试结果：
 *      用户名：asdf
 *      密码：asdf' or '1'='1
 *      登录失败
 ...
 *
 *      综上所述：PreparedStatement使用较多，只有极少的情况下需要使用Statement
...
public class JDBCTest07 {
    ...
    private static boolean login(Map<String, String> userLoginInfo) {
        ...
        try {
            ...
            //给占位符？传值（第一个问号下标是1，第二个问好下标是2，JDBC中所有的下标从1开始）
